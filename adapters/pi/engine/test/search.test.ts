...
import { openExistingRoot } from "../corpus.ts";
import { capture } from "../store.ts";
import { openSnapshot, type Snapshot } from "../index.ts";
import { sync, reseal } from "../ops.ts";
import { rootDigestHex } from "../paths.ts";
import { search, get, creditLine } from "../search.ts";
import { idfWeight, recencyMultiplier, confidenceWithCoverage, cursorEncode, cursorDecode } from "../retrieval.ts";
import { loadAliasMapFromBytes } from "../aliases.ts";
